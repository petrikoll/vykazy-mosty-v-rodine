...
assert.equal(first.schemaVersion, 9, "legacy data is upgraded to the current schema version");
assert.deepEqual(first.methodologyAnswers, [], "legacy data receives an empty methodology answer collection");
