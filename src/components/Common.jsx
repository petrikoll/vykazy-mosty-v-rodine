...
export const StatusBadge = ({ status }) => {
  const labels = {
    scheduled: "Založeno – čeká na zápis", draft: "Koncept", submitted: "Předáno", ready_for_signature: "Připraveno k podpisu", returned: "Vráceno k opravě",
  ...
  const colors = {
    scheduled: "bg-blue-100 text-blue-800", draft: "bg-slate-100 text-slate-700", submitted: "bg-amber-100 text-amber-800", ready_for_signature: "bg-blue-100 text-blue-800",
